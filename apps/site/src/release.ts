...
export const OMP_RUNTIME_VERSION = "17.0.9";
export const OMP_RUNTIME_COMMIT = "639bac596d94b5993349f3f6696176cb2bf9b5d3";
export const OMP_RUNTIME_TAG = "v17.0.9";
export const OMP_RUNTIME_URL = `https://github.com/can1357/oh-my-pi/tree/${OMP_RUNTIME_TAG}`;
export const OMP_UPSTREAM_TAG = "v17.0.9";
export const OMP_UPSTREAM_COMMIT = "639bac596d94b5993349f3f6696176cb2bf9b5d3";
