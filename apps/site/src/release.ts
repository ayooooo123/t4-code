...
export const OMP_RUNTIME_VERSION = "17.2.4";
export const OMP_RUNTIME_COMMIT = "06343fef4200c4e32d18f08df5a6a8bd84dcc710";
export const OMP_RUNTIME_TAG = "v17.2.4";
export const OMP_RUNTIME_URL = `https://github.com/can1357/oh-my-pi/tree/${OMP_RUNTIME_TAG}`;
export const OMP_UPSTREAM_TAG = "v17.2.4";
export const OMP_UPSTREAM_COMMIT = "06343fef4200c4e32d18f08df5a6a8bd84dcc710";
