...
import { Badge, Badges, Output, PathText, ResultText } from "../parts.tsx";
import type { ToolRenderer, ToolRenderProps } from "../types.ts";
import { num, str, truncate } from "../util.ts";
    ...
    <>
      <Badges
        items={[
          ...
          filePath && (
            <PathText path={filePath} from={lineStart ?? undefined} to={lineEnd ?? undefined} />
          ),
        ]}
      />
