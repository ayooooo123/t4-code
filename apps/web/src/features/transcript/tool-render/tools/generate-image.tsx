...
import type { ToolRenderer, ToolRenderProps, ToolResultBlock, ToolResultLike } from "../types.ts";
import { detailsRecord, isRecord, normalizeWs, resultImagesOf, str, truncate } from "../util.ts";
