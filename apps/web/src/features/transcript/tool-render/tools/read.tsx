...
import { Badge, Badges, Kv, KvGrid, PathText, ResultImages, ResultText } from "../parts.tsx";
import type { ToolRenderer, ToolRenderProps } from "../types.ts";
import { detailsRecord, isRecord, languageFromPath, num, shortenPath, str } from "../util.ts";
