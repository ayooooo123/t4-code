...
import { Badge, CodeBlock, Kv, KvGrid, PathText, ResultText } from "../parts.tsx";
import type { ToolRenderer, ToolRenderProps } from "../types.ts";
import { detailsRecord, display, isRecord, normalizeWs, num, str, truncate } from "../util.ts";
...
function Body(props: ToolRenderProps): ReactNode {
  ...
  return (
    <>
      ...
      {customArgsJson && (
        <CodeBlock code={customArgsJson} lang="json" title="arguments" maxLines={10} />
      )}
      {snapshot && (
        <KvGrid>
