...
import { Badge, Badges, InvalidArg, PathText, ResultImages, ResultText, Row } from "../parts.tsx";
import type { ToolRenderer, ToolRenderProps } from "../types.ts";
import { detailsRecord, normalizeWs, shortenPath, str, truncate } from "../util.ts";
...
function Body({ args, result }: ToolRenderProps): ReactNode {
  ...
  return (
    <>
      ...
      <Badges
        items={[
          model && <Badge tone="accent">{model}</Badge>,
